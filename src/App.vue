...
const live2d_assets_dir = "/live2d_assets/";
...
const loadModel = async () => {
  ...
  try {
    ...
    const modelHomeDir = live2d_assets_dir + modelName.value;
    ...
    viewer.setCurrentModelk('sample')
  ...
  <main class="app-shell">
    ...
    <aside class="control-panel">
      ...
      <div class="requirements">
        ...
        <code>public{{ live2d_assets_dir + modelName }}{{ modelJsonFileName }}</code>
      </div>
